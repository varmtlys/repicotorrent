...
TorrentDetailsView::TorrentDetailsView(wxWindow* parent, wxWindowID id, std::shared_ptr<pt::Core::Configuration> cfg, pt::Core::GeoIP const* geoip)
    ...
    m_peers(new TorrentDetailsPeersPanel(this, wxID_ANY, geoip)),
